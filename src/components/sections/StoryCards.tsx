export default function StoryCards() {
  return (
    <section
      ...
      className="relative isolate z-0 mx-auto max-w-6xl px-4 py-14 md:py-20"
    >
      <h2 id="story-cards-heading" className="sr-only">
        From problem to solution
      </h2>

      {/* One parent controls the pin/stack */}
      <div className="relative md:h-[135vh]">
        {/* Card 1 (bottom) */}
        <article
          className="
            ...
            md:sticky md:top-[160px] md:z-[1] md:-rotate-[0.9deg]
        ...
        <article
          className="
            ...
            p-6 md:px-9 md:py-8 backdrop-blur-xl
            shadow-[0_24px_70px_-24px_rgba(0,0,0,0.6)]
            md:sticky md:top-[160px] md:z-[2] md:mt-[18vh] md:rotate-[0.9deg]
            motion-reduce:transform-none
          "
        >
          <h3 className="text-2xl md:text-[30px] font-extrabold bg-gradient-to-r from-orange-400 via-amber-300 to-pink-500 bg-clip-text text-transparent">
        ...
        <article
          className="
            ...
            p-6 md:px-9 md:py-8 backdrop-blur-xl
            shadow-[0_24px_70px_-24px_rgba(0,0,0,0.6)]
            md:sticky md:top-[160px] md:z-[3] md:mt-[36vh] md:-rotate-[0.45deg]
            motion-reduce:transform-none
          "
        >
          <h3 className="text-2xl md:text-[30px] font-extrabold bg-gradient-to-r from-orange-400 via-amber-300 to-pink-500 bg-clip-text text-transparent">
          ...
          {/* (No body copy — matches your original) */}
        </article>

        {/* End spacer so the last card unpins before the next section */}
        <div aria-hidden className="pointer-events-none h-[18vh]" />
      </div>

      {/* Mobile: normal stacked blocks */}
      <div className="md:hidden mt-8 space-y-6">
        <div className="rounded-[26px] border border-white/12 bg-white/7 p-6 backdrop-blur-xl">
          ...
          <p className="mt-3 text-white/90 leading-relaxed">
            ...
            So you often feel <strong>frustrated</strong> and feel like it <strong>limits</strong> your full potential as a player. Aiming should just feel <strong>natural</strong> for maximized <strong>confidence</strong> and <strong>fun</strong>.
          </p>
        </div>
        <div className="rounded-[26px] border border-white/12 bg-white/7 p-6 backdrop-blur-xl">
          <h3 className="text-2xl font-extrabold bg-gradient-to-r from-orange-400 via-amber-300 to-pink-500 bg-clip-text text-transparent">
